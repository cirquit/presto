...
from cubeplusplus_pipeline import pipeline_definition
...
source_path_local = f"{home_path}/Downloads/cubeplusplus/{datatype}"
target_path_local = "."
source_path_vm_local = f"{home_path}/cubeplusplus/{datatype}"
target_path_vm_local = f"{home_path}/dataset-profiles"
source_path_ceph = f"{home_path}/rbgstorage/cubeplusplus/{datatype}"
...
strat_analysis.save_dfs_as_csv(path="./logs", prefix=f"cubeplusplus-{datatype}-application-cache")
