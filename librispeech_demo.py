...
source_path_local = f"{home_path}/Downloads/datasets/LibriSpeech/train-clean-100"
target_path_local = "."
source_path_vm_local = f"{home_path}/LibriSpeech/train-clean-100"
target_path_vm_local = f"{home_path}/dataset-profiles"
source_path_ceph = f"{home_path}/rbgstorage/librispeech/train-clean-100"
...
del librispeech_pipeline_steps[2] # remove the 2-decode-flac strategy for application level cache
del librispeech_pipeline_steps[1] # remove the 1-list-files strategy from profiling
del librispeech_pipeline_steps[0] # remove the 0-fully-online strategy from profiling for compression tests
...
strat_analysis.save_dfs_as_csv(path="./logs", prefix=f"librispeech-application-cache")
